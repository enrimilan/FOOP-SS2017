...
extern EIF_TYPED_VALUE F993_7362(EIF_REFERENCE);
...
RTOID (F993_7362)
EIF_TYPED_VALUE F993_7362 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 992, Current, 0, 0, 13496);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(992, Current, 13496);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
