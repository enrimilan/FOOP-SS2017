...
extern EIF_TYPED_VALUE F996_7382(EIF_REFERENCE);
...
RTOID (F996_7382)
EIF_TYPED_VALUE F996_7382 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 995, Current, 0, 0, 13516);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(995, Current, 13516);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
