...
extern EIF_TYPED_VALUE F995_7381(EIF_REFERENCE);
...
RTOID (F995_7381)
EIF_TYPED_VALUE F995_7381 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 994, Current, 0, 0, 13515);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
