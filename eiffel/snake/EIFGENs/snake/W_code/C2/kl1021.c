...
extern EIF_TYPED_VALUE F1021_7757(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1021_7757 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1020, Current, 0, 0, 13877);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1020, Current, 13877);
	RTIV(Current, RTAL);
	RTHOOK(1);
