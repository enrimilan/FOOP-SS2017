...
extern EIF_TYPED_VALUE F1002_7426(EIF_REFERENCE);
...
RTOID (F1002_7426)
EIF_TYPED_VALUE F1002_7426 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1001, Current, 0, 0, 13555);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1001, Current, 13555);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
