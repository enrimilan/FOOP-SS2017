...
extern EIF_TYPED_VALUE F979_7289(EIF_REFERENCE);
...
RTOID (F979_7289)
EIF_TYPED_VALUE F979_7289 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 978, Current, 0, 0, 13424);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(978, Current, 13424);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
