...
extern EIF_TYPED_VALUE F982_7352(EIF_REFERENCE);
...
RTOID (F982_7352)
EIF_TYPED_VALUE F982_7352 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 981, Current, 0, 0, 13487);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(981, Current, 13487);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
