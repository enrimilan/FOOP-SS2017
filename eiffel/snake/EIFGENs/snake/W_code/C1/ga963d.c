...
static const EIF_TYPE_INDEX egt_13_963 [] = {0xFF01,963,0xFFFF};
static const EIF_TYPE_INDEX egt_14_963 [] = {0xFF01,963,0xFFFF};
...
static const struct desc_info desc_963[] = {
	...
	{EIF_GENERIC(egt_13_963), 13258, 0},
	...
	{EIF_GENERIC(egt_14_963), 13257, 0xFFFFFFFF},
};
void Init963(void)
{
	IDSC(desc_963, 0, 962);
	IDSC(desc_963 + 1, 1, 962);
	IDSC(desc_963 + 32, 364, 962);
	IDSC(desc_963 + 34, 359, 962);
}
