...
extern EIF_TYPED_VALUE F983_7353(EIF_REFERENCE);
...
RTOID (F983_7353)
EIF_TYPED_VALUE F983_7353 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 982, Current, 0, 0, 13488);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(982, Current, 13488);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
