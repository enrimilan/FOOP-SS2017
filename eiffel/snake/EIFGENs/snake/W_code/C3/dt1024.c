...
extern EIF_TYPED_VALUE F1024_7770(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1024_7771(EIF_REFERENCE);
extern void F1024_7772(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1024_7773(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {DT_DATE_VALUE}.out */
EIF_TYPED_VALUE F1024_7770 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1023, Current, 0, 0, 13882);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1023, Current, 13882);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
/* {DT_DATE_VALUE}.date_out */
EIF_TYPED_VALUE F1024_7771 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "date_out";
	RTEX;
	EIF_TYPED_VALUE ur1x = {{0}, SK_REF};
#define ur1 ur1x.it_r
	EIF_TYPED_VALUE ui4_1x = {{0}, SK_INT32};
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1023, Current, 0, 0, 13883);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1023, Current, 13883);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0xF80000E3, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(227, 0x01).id);
...
void F1024_7772 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1023, Current, 0, 1, 13884);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1023, Current, 13884);
	RTCC(arg1, 1023, l_feature_name, 1, eif_new_type(227, 0x01), 0x01);
	RTIV(Current, RTAL);
...
void F1024_7773 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1023, Current, 0, 1, 13885);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1023, Current, 13885);
	RTCC(arg1, 1023, l_feature_name, 1, eif_new_type(227, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
